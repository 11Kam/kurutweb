                                    ...
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <?php 
                                            ...
                                            <tr>
                                                    ...
                                                    <td><?php echo $category_total_post; ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php 
                                                            ...
                                                            <?php } else {?>
                                                                <button title="You can not delete category that has a post!" name="delete-category" class="btn btn-red btn-icon"><i data-feather="trash-2"></i></button>
                                                            <?php }
                                                        ?>
                                                    </td>
                                            </tr>
