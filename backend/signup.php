...
<?php 
        if(isset($_SESSION['login']) || isset($_COOKIE['_uid_']) || isset($_COOKIE['_unick_'])) {
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header justify-content-center"><h3 class="font-weight-light my-4">Register</h3></div>
                                    <div class="card-body">
                                        <form action="signup.php" method="POST">
                                                ...
                                                echo "<p class='alert alert-danger'>{$error_nickname_exist}</p>";
                                                    ...
                                                    echo "<p class='alert alert-danger'>{$error_email_exist}</p>";
                                                        ...
                                                        echo "<p class='alert alert-danger'>{$error}</p>";
                                                            ...
                                                            echo "<p class='aler alert-success'>
                                            ...
                                            <div class="form-group"><label class="small mb-1" for="nickname">Nickname</label>
                                                <input name="nickname" class="form-control py-4" id="inputEmailAddress" type="text" placeholder="Enter nickname" required="true" />
                                            </div>
