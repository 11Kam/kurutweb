                                        ...
                                        <?php
                                            ...
                                            if(isset($_POST['update'])) {
                                                ...
                                                if($password == $confirm_password) {
                                                    ...
                                                    echo "<p class='alert alert-success'>Password reset is successful. </br> <a href='signin.php'>Login now</a></p>";
                                                } else {
                                           ...
                                           <?php } else { ?>
                                                <form action="forgot-password.php" method="POST">
                                                    ...
                                                    <input name="id" value="<?php echo $user_id ; ?> " type ="hidden" />
                                                        <label class="small mb-1" for="passowrd">Password</label>
                                                        <input name="passowrd" class="form-control py-4" id="passowrd" type="password" placeholder="Password" required="true" />
                                                    </div>
                                                    <div class="form-group">
