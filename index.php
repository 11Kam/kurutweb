            ...
            <div id="layoutDefault_content">
                <main>
                    ...
                    <nav class="navbar navbar-marketing navbar-expand-lg bg-white navbar-light">
                        <div class="container">
                            <a class="navbar-brand text-dark" href="index.php">KurutWeb</a><button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><img src="img/menu.png" style="height:20px;width:25px" /><i data-feather="menu"></i></button>
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-xl-8 col-lg-10 text-center">
                                        ...
                                        <h1 class="page-header-title">Welcome to KurutWeb!</h1>
                                        <p class="page-header-text mb-5">Search the content you are looking for!</p>
                        ...
                        <?php 
                             ...
                             $stmt = $pdo->prepare($sql4);
                                    ...
                                    $posts = $stmt->fetch(PDO::FETCH_ASSOC);
                                            ...
                                            $post_detail = substr($posts['post_detail'], 0, 300); 
                                    ...
                                    <div class="col-lg-7">
                                        <div class="card-body">
                                            ...
                                            <div class="post-preview-meta">
                                                <img class="post-preview-meta-img"  src="./img/<?php echo $post_image; ?>"/>
                            ...
                            <div class="row features text-center mb-5">
                                <?php  
                                    ...
                                    while ($categories = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        $category_posts = $categories['category_total_post']; 
                                        if($category_posts > 0) {
                                ...
                                ?>
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-5">
                                        <a class="card card-link border-top border-top-lg border-primary h-100 lift" href="categories.php?category_id=<?php echo $category_id; ?>&category_name=<?php echo $category_title; ?>"
                                            ...
                                            <div class="card-footer bg-transparent pt-0 pb-5"><div class="badge badge-pill badge-light font-weight-normal px-3 py-2">
                                            <?php echo $category_posts; ?></div></div></a>
                ...
                <footer class="footer pt-2 pb-4 mt-auto bg-dark footer-dark">
                    <div class="container">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6 small">Copyright &#xA9; KurutWeb 2021</div>
