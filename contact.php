                ...
                <main>
                            ...
                            <div class="container text-center">
                                <div class="row justify-content-center">
                                    <div class="col-lg-8">
                                        ...
                                        <p class="page-header-text">Hello, this is KurutWeb web learning platform! You can contact us. We will respond as soon as possible</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="bg-white py-10">
                        <div class="container">
                            ...
                            <?php 
                                if(isset($_COOKIE['_uid_']) || isset($_COOKIE['_unick_']) || isset($_SESSION['login'])) { ?>
